...
// The page wrapper for the RocketArb addon config
type AddonArbPage struct {
...
// Creates a new page for the RocketArb addon settings
func NewAddonArbPage(addonsPage *AddonsPage, addon addons.SmartnodeAddon) *AddonArbPage {

	configPage := &AddonArbPage{
		addonsPage:   addonsPage,
...
func (configPage *AddonArbPage) getPage() *page {
	return configPage.page
}

// Creates the content for the RocketArb settings page
func (configPage *AddonArbPage) createContent() {
...
func (configPage *AddonArbPage) handleEnableChanged() {
...
func (configPage *AddonArbPage) handleLayoutChanged() {
	configPage.handleEnableChanged()
}
